...
var MultilineRegExp$1 = MultilineRegExp;
...
var MAIN = new Grammar('html', {
  ...
  'embedded embedded-javascript': {
    pattern: MultilineRegExp$1(_templateObject),
...
var wrap$1 = wrap;
var MultilineRegExp$2 = MultilineRegExp;
...
MAIN$1.extend({
  ...
  'meta: fat arrow function, args in parens': {
    pattern: MultilineRegExp$2(_templateObject$1),
  ...
  'function function-expression': {
    pattern: MultilineRegExp$2(_templateObject2),
  ...
  'function function-literal-shorthand-style': {
    pattern: MultilineRegExp$2(_templateObject3),
  ...
  'function function-assigned-to-variable': {
    pattern: MultilineRegExp$2(_templateObject4),
  ...
  'meta: class definition': {
    pattern: MultilineRegExp$2(_templateObject5),
...
var MultilineRegExp$3 = MultilineRegExp;
...
var MAIN$2 = new Grammar('python', {
  ...
  keyword: {
    pattern: MultilineRegExp$3(_templateObject$2)
  },
  ...
  'meta: method definition': {
    pattern: MultilineRegExp$3(_templateObject2$1),
  ...
  'meta: method invocation': {
    pattern: MultilineRegExp$3(_templateObject3$1),
...
var MultilineRegExp$4 = MultilineRegExp;
...
var MAIN$3 = new Grammar('ruby', {
  ...
  'block block-do-end': {
    pattern: MultilineRegExp$4(_templateObject$3),
    replacement: compact$4('\n      <b class=\'#{name}\'>\n        <span class=\'keyword\'>#{1}</span>#{2}\n        <span class=\'punctuation pipe\'>#{3}</span>\n        #{4}\n        <span class=\'punctuation pipe\'>#{5}</span>\n    '),
    before: function before(r, context) {
      // Keep a LIFO stack of block braces. When we encounter a brace that
      // we don't recognize later on, we'll pop the last scope off of the
  ...
  'meta: class definition with superclass': {
    pattern: MultilineRegExp$4(_templateObject2$2),
...
var MultilineRegExp$5 = MultilineRegExp;
...
var SELECTORS = new Grammar({
  ...
  'selector selector-attribute': {
    pattern: MultilineRegExp$5(_templateObject$4),
...
var VALUES$2 = new Grammar({
  ...
  'meta: value with unit': {
    pattern: MultilineRegExp$5(_templateObject2$3),
...
MAIN$4.extend({
  'meta: selector line': {
    pattern: MultilineRegExp$5(_templateObject3$2),
    index: function index(match) {
